...
This function uses influence curves to calculate the difference and standard error in cumulative hazard or mean incidence for an effect modification variable.
...
1. The estimate and standard error for the difference in the cumulative hazard (or mean) incidence between treated and untreated patients amongst those *with* the effect modification variable.

2. The estimate and standard error for the difference in the cumulative hazard (or mean) incidence between treated and untreated patients amongst those *without* the effect modification variable.
...
1. A significant effect on the cumulative hazard incidence at `t0` between the treated and untreated observations for those *with* the effect modification variable.

2. A non-significant effect on the cumulative hazard incidence at `t0` between the treated and untreated observations for those *without* the effect modification variable.

3. An overall significant modification effect on the outcome.
